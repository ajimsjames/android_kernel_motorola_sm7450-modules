...
__used __section("__versions") = {
	...
	{ 0xf9a482f9, "msleep" },
	{ 0x1824ecfa, "snd_soc_component_exit_regmap" },
	...
	{ 0x8d73dfc1, "msm_cdc_release_supplies" },
...
MODULE_INFO(depends, "wcd_core_dlkm,swr_dlkm,adsp_loader_dlkm,qti-regmap-debugfs");
